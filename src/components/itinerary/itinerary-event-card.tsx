...
export function ItineraryEventCard({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex w-full flex-col gap-3 rounded-xl border bg-background/70 p-3 text-left backdrop-blur transition-all hover:bg-accent/50 hover:shadow-sm",
